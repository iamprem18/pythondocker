...
#Print the Name,Date,Days to expire
print ("{:<30} | {:<20} | {:<10}".format('NAME', 'DATE OF EXPIRY', 'DAYS TO EXPIRE'))
print ("----------------------------------------------------------------------") 
for num in ssl_list:
	print ("{:<30} | {:<20} | {:<10}".format(num.get('Name'),num.get('Date'),num.get('Days')))
